    ...
    return (
      <div className="flex w-full max-w-xl flex-col gap-8">
        <button
          ...
          disabled={loading}
          className="self-start text-sm font-medium text-zinc-500 transition-colors hover:text-zinc-950 disabled:opacity-50"
        >
          ← Back
        </button>

        <div>
          <h1 className="text-2xl font-semibold text-zinc-950">Set up your store</h1>
  ...
  return (
    <div className="flex w-full max-w-2xl flex-col gap-10">
      <div className="text-center">
        <h1 className="text-2xl font-semibold text-zinc-950">Welcome, {user.firstName}.</h1>
        <p className="mt-2 text-sm text-zinc-500">Ready to start selling on YIIVA?</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            <h2 className="text-base font-semibold text-zinc-950">Start my store</h2>
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            <h2 className="text-base font-semibold text-zinc-950">I&apos;m just looking around</h2>
            <p className="text-sm text-zinc-500 leading-relaxed">
